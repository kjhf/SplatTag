...
namespace SplatTagCore
{
  ...
  public static class ASCIIFold
  {
      ...
      for (int pos = 0; pos < end; ++pos)
      {
        ...
        else
        {
          switch (c)
          {
            ...
            // MODIFIED
            // Non-standard Latin characters
            case 'Ɑ':
            case 'ɑ': s.Append('a'); break;
            case 'Ꞵ':
            case 'ꞵ': s.Append('B'); break;
            case 'Ɣ': s.Append('Y'); break;
            case 'ɣ': s.Append('y'); break;
            case 'I':
            case 'ɩ': s.Append('l'); break;
            case 'Ꞷ': s.Append('W'); break;
            case 'ꞷ': s.Append('w'); break;
            case 'Ʊ': s.Append('U'); break;
            case 'ʊ': s.Append('u'); break;
            case 'K': s.Append('K'); break;
            case 'Ʃ': s.Append('E'); break;
            case 'ʃ': s.Append('S'); break;
            case 'Ʒ':
            case 'ʒ': s.Append('3'); break;
            case 'ʔ': s.Append('?'); break;

            // Greek
            case 'Α': s.Append('A'); break;
            case 'α': s.Append('a'); break;
            case 'Β': s.Append('B'); break;
            case 'β': s.Append('b'); break;
            case 'Γ': s.Append('C'); break;
            case 'γ': s.Append('y'); break;
            case 'Δ': s.Append('D'); break;
            case 'δ': s.Append('d'); break;
            case 'Ε': s.Append('E'); break;
            case 'ε': s.Append('e'); break;
            case 'Ζ': s.Append('Z'); break;
            case 'ζ': s.Append('z'); break;
            case 'Η': s.Append('H'); break;
            case 'η': s.Append('n'); break;
            case 'Θ': s.Append('O'); break;
            case 'θ': s.Append('o'); break;
            case 'Ι': s.Append('I'); break;
            case 'ι': s.Append('ι'); break;
            case 'Κ': s.Append('K'); break;
            case 'κ': s.Append('κ'); break;
            case 'Λ': s.Append('A'); break;
            case 'λ': s.Append('l'); break;
            case 'Μ': s.Append('M'); break;
            case 'μ': s.Append('u'); break;
            case 'Ν': s.Append('N'); break;
            case 'ν': s.Append('v'); break;
            case 'Ξ': s.Append('E'); break;
            case 'ξ': s.Append('e'); break;
            case 'Ο': s.Append('O'); break;
            case 'ο': s.Append('o'); break;
            case 'Π': s.Append('N'); break;
            case 'π': s.Append('n'); break;
            case 'Ρ': s.Append('P'); break;
            case 'ρ': s.Append('p'); break;
            case 'Σ': s.Append('E'); break;
            case 'σ': s.Append('o'); break;
            case 'ς': s.Append('c'); break;
            case 'Τ': s.Append('T'); break;
            case 'τ': s.Append('t'); break;
            case 'Υ': s.Append('Y'); break;
            case 'υ': s.Append('u'); break;
            case 'Φ': s.Append('O'); break;
            case 'φ': s.Append('o'); break;
            case 'Χ': s.Append('X'); break;
            case 'χ': s.Append('x'); break;
            case 'Ψ': s.Append('Y'); break;
            case 'ψ': s.Append('y'); break;
            case 'Ω': s.Append('O'); break;
            case 'ω': s.Append('w'); break;

            // Cyrillic
            case 'А': s.Append('A'); break;
            case 'а': s.Append('a'); break;
            case 'Б': s.Append('B'); break;
            case 'б': s.Append('b'); break;
            case 'В':
            case 'в': s.Append('B'); break;
            case 'Г': s.Append('R'); break;
            case 'г': s.Append('r'); break;
            case 'Д': s.Append('A'); break;
            case 'д': s.Append('a'); break;
            case 'Є': s.Append('E'); break;
            case 'є': s.Append('e'); break;
            case 'Ж': s.Append('X'); break;
            case 'ж': s.Append('x'); break;
            case 'Ѕ': s.Append('S'); break;
            case 'ѕ': s.Append('s'); break;
            case 'Ꙃ': s.Append('Z'); break;
            case 'ꙃ': s.Append('z'); break;
            case 'З':
            case 'з': s.Append('3'); break;
            case 'Ꙁ': s.Append('Z'); break;
            case 'ꙁ': s.Append('z'); break;
            case 'И': s.Append('N'); break;
            case 'и': s.Append('n'); break;
            case 'І': s.Append('I'); break;
            case 'і': s.Append('і'); break;
            case 'Ї': s.Append('I'); break;
            case 'ї': s.Append('i'); break;
            case 'К': s.Append('K'); break;
            case 'к': s.Append('k'); break;
            case 'Л': s.Append('N'); break;
            case 'л': s.Append('n'); break;
            case 'М': s.Append('M'); break;
            case 'м': s.Append('m'); break;
            case 'Н': s.Append('H'); break;
            case 'н': s.Append('h'); break;
            case 'О': s.Append('O'); break;
            case 'о': s.Append('o'); break;
            case 'П': s.Append('n'); break;
            case 'п': s.Append('n'); break;
            case 'Р': s.Append('P'); break;
            case 'р': s.Append('p'); break;
            case 'С': s.Append('C'); break;
            case 'с': s.Append('c'); break;
            case 'Т': s.Append('T'); break;
            case 'т': s.Append('t'); break;
            case 'Ꙋ': s.Append("oy"); break;
            case 'ꙋ': s.Append('y'); break;
            case 'Ф': s.Append('O'); break;
            case 'ф': s.Append('o'); break;
            case 'Х': s.Append('X'); break;
            case 'х': s.Append('x'); break;
            case 'Ѡ': s.Append('W'); break;
            case 'ѡ': s.Append('w'); break;
            case 'Ц': s.Append('U'); break;
            case 'ц': s.Append('u'); break;
            case 'Ч': s.Append('Y'); break;
            case 'ч': s.Append('y'); break;
            case 'Ш': s.Append('W'); break;
            case 'ш': s.Append('w'); break;
            case 'Щ': s.Append('W'); break;
            case 'щ': s.Append('w'); break;
            case 'Ъ': s.Append('b'); break;
            case 'ъ': s.Append('b'); break;
            case 'Ꙑ':
            case 'ꙑ': s.Append("bI"); break;
            case 'Ь':
            case 'ь':
            case 'Ѣ':
            case 'ѣ': s.Append('b'); break;
            case 'Ꙗ': s.Append("IA"); break;
            case 'ꙗ': s.Append("Ia"); break;
            case 'Ѥ':
            case 'ѥ': s.Append("IE"); break;
            case 'Ю':
            case 'ю': s.Append("IO"); break;
            case 'Ѫ': s.Append('M'); break;
            case 'ѫ': s.Append('m'); break;
            case 'Ѭ': s.Append("IM"); break;
            case 'ѭ': s.Append("Im"); break;
            case 'Ѧ':
            case 'ѧ': s.Append('A'); break;
            case 'Ѩ':
            case 'ѩ': s.Append("IA"); break;
            case 'Ѯ': s.Append('Z'); break;
            case 'ѯ': s.Append('z'); break;
            case 'Ѱ': s.Append('Y'); break;
            case 'ѱ': s.Append('y'); break;
            case 'Ѳ': s.Append('O'); break;
            case 'ѳ': s.Append('o'); break;
            case 'Ѵ': s.Append('V'); break;
            case 'ѵ': s.Append('v'); break;
            case 'Ҁ': s.Append('G'); break;
            case 'ҁ': s.Append('c'); break;

            // Symbols
            case ' ': s.Append(' '); break;
            case '¡': s.Append('i'); break;
            case '¢': s.Append('c'); break;
            case '£': s.Append('E'); break;
            case '¤': s.Append('o'); break;
            case '¥': s.Append('Y'); break;
            case '¦': s.Append('I'); break;
            case '§': s.Append('S'); break;
            case '¨': s.Append('"'); break;
            case '©': s.Append("(C)"); break;
            case 'ª': s.Append('a'); break;
            case '¬': s.Append('-'); break;
            case '®': s.Append("(R)"); break;
            case '¯': s.Append('-'); break;
            case '°': s.Append('o'); break;
            case '±': s.Append("+-"); break;
            case '´': s.Append('\''); break;
            case 'µ': s.Append('u'); break;
            case '¶': s.Append('q'); break;
            case '·': s.Append('.'); break;
            case '¸': s.Append(','); break;
            case 'º': s.Append('o'); break;
            case '¼': s.Append("1/4"); break;
            case '½': s.Append("1/2"); break;
            case '¾': s.Append("3/4"); break;
            case '¿': s.Append('?'); break;
    ...
    /// <summary>
    /// Transforms characters into a near Latin alphabet character.
    /// Result may have a different length.
    /// Returns empty if nothing to do.
    /// </summary>
    /// <remarks>
    /// The transformation here is arbitrarily set by visual inspection and should not be regarded as 'finished'
